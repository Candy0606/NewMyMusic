...
<head>
    ...
    <script src="/static/js/supersized.3.2.7.min.js" type="text/javascript"></script>
    <script src="/static/js/supersized-init.js" type="text/javascript"></script>
...
<body>
    <div id="ldiv1">
        <form  id="form1" action="Linsert" method="post">
            <table>
                <tr><td style="text-align: center"><img src="static/img/Logo.jpg" class="Limage1"></td></tr>
                <tr>
